...
const resulting = add(2, 3);
console.log(resulting);

//return이 나오면 함수가 종료되므로 종료용으로 사용할 때가 있다.
 ...
 * function sayGoodBye(){
 * console.log('Hello)};
 * 이건 함수 선언문 (어디서든 호출 가능)
 */

let sayGoodBye = function () {
  console.log("Hello");
}; //함수 표현식 이건 코드에 도달해야 생성된다.그래서 그 이후에만 사용가능

//호이스팅이란 함수가 선언된 것들이 먼저 상위로 올라가게 되면서 어디에서든 함수를 호출하는게
//가능한 것이다.
 ...
 *
 * 그리고 이걸
 * let add1=(num1,num2)=>(num1+num2;) 이렇게 바꾸는게 가능
 *
 * 그리고 괄호도 생략 가능
